...
class MyObjectsAdapter(private var objets: List<Objet>) : RecyclerView.Adapter<MyObjectsAdapter.MyObjectViewHolder>() {
    ...
    class MyObjectViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
