...
import com.app.swapsavvy.objetlist.HistoriqueEchangeActivity
import com.bumptech.glide.Glide

class HistoriqueEchangeAdapter (
    private var echanges: List<EchangeApiResponse>
) : RecyclerView.Adapter< HistoriqueEchangeAdapter. HistoriqueEchangeViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int):  HistoriqueEchangeViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_historique_echange, parent, false)
        return  HistoriqueEchangeViewHolder(view)
    }

    override fun onBindViewHolder(holder:  HistoriqueEchangeViewHolder, position: Int) {
    ...
    class HistoriqueEchangeViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        private val titleTextView1: TextView = itemView.findViewById(R.id.titreTextView1)
        private val descriptionTextView1: TextView =
            itemView.findViewById(R.id.descriptionTextView1)
        private val statusTextView1: TextView = itemView.findViewById(R.id.statutTextView1)
        private val estimatedValueTextView1: TextView =
            itemView.findViewById(R.id.valeurEstimeeTextView1)
        ...
        private val descriptionTextView2: TextView =
            itemView.findViewById(R.id.descriptionTextView2)
        private val statusTextView2: TextView = itemView.findViewById(R.id.statutTextView2)
        private val estimatedValueTextView2: TextView =
            itemView.findViewById(R.id.valeurEstimeeTextView2)
        ...
        private val datePropositionTextView: TextView =
            itemView.findViewById(R.id.datePropositionTextView)
        ...
        fun bind(echange: EchangeApiResponse) {
            ...
            echange.objet_proposant?.let { objetResponse ->
                ...
                descriptionTextView1.text =
                    objetResponse.description ?: "Description non disponible"
                estimatedValueTextView1.text =
                    "Valeur estimée: ${objetResponse.valeur_estimee ?: "Non disponible"}"
            ...
            ownerTextView1.text =
                "Propriétaire: ${echange.utilisateur_proposant_id?.nom ?: "Non spécifié"}"
            ...
            echange.objet_acceptant?.let { objetResponse ->
                ...
                descriptionTextView2.text =
                    objetResponse.description ?: "Description non disponible"
                estimatedValueTextView2.text =
                    "Valeur estimée: ${objetResponse.valeur_estimee ?: "Non disponible"}"
                Glide.with(itemView.context)
                    .load(objetResponse.image_url ?: R.drawable.default_image)
                    .placeholder(R.drawable.default_image)
            ...
            ownerTextView2.text =
                "Propriétaire: ${echange.utilisateur_acceptant_id?.nom ?: "Non spécifié"}"
            ...
            datePropositionTextView.text =
                "Date de proposition: ${echange.date_proposition ?: "Non spécifiée"}"
