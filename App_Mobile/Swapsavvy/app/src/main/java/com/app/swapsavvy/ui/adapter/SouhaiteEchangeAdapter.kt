...
class SouhaiteEchangeAdapter(
...
) : RecyclerView.Adapter<SouhaiteEchangeAdapter.SouhaitViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SouhaitViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_souhaite_echange, parent, false)
        return SouhaitViewHolder(view)
    }

    override fun onBindViewHolder(holder: SouhaitViewHolder, position: Int) {
    ...
    class SouhaitViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
